...
{
    //GetById query'si genelde 1 kayıt döneceği için Model yerine Dto yapısı kullanılıyor.
    //Ama ilerideki ihtiyaçlara göre daha fazla kayıt dönecekse Model yapısı da kullanılabilir.
